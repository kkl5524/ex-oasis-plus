...
# test data
test_file = 'output/data/test/oasis_test.csv'  
test_lbl = 'IN_HOSPITAL_MORTALITY'  
threshold = 0.10    

# file for saving OASIS+ predicted scores
out_file = 'output/data/oasis_preds.csv' 
...
# Report performance of labels of test data are provided
if test_lbl is not None:
